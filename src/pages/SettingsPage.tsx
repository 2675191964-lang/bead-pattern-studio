  ...
  return (
    <div className="narrow-page">
      ...
      <section className="settings-card card">
        ...
        <label><span><Ruler size={19} /><b>默认长边格数</b></span><input type="number" min="1" max="200" value={draft.defaultGridWidth} onChange={(event) => setDraft({ ...draft, defaultGridWidth: Math.max(1, Math.min(200, Number(event.target.value))) })} /><small>建议 29–80；超过 100 会自动使用适屏预览，200×200 等于 40,000 格。</small></label>
